...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝙁𝙧𝙪 𝙏𝙝𝙚 𝙂𝙧𝙚𝙖𝙩", canvas.width / 2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("FruV2 Project", canvas.width / 2 - 660, 1000);
...
}  //You Can Customize Some Of User Defined Names And Texts For The Output
